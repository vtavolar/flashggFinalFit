...
####################################################
	...
	cp ../../Signal/$OUTDIR/CMS-HGG_sigfit_${EXT}.root .
	cp ../../Background/CMS-HGG_multipdf_${EXT}${FAKE}.root CMS-HGG_${EXT}${FAKE}_13TeV_multipdf.root
	cp ../../Datacard/Datacard_13TeV_$EXT.txt .
	...
	sed -i -e "s/multipdf.root/multipdf${FAKE}.root/g" Datacard_13TeV_$EXT.txt
#INTLUMI="2.7"
