...
##cmsenv
#
#bash multi_signal_model_pT_ExtraBin.sh $DIR $THEDATACARD | tee out_${DIR}.log
...
python makeCombinePlots.py  -b -f /mnt/t3nfs01/data01/shome/vtavolar/combine74/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/test/$DIR/higgsCombiner7_np10.MultiDimFit.mH125.root --mu --muExpr "r7" -o scan_${DIR}_r7
##python makeCombinePlots.py  -b -f /mnt/t3nfs01/data01/shome/vtavolar/combine74/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/test/$DIR/higgsCombiner4_np10.MultiDimFit.mH125.root --mu --muExpr "r8" -o scan_${DIR}_r8
...
#python makeCombinePlots.py  -b -f /mnt/t3nfs01/data01/shome/vtavolar/combine74/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/test/$DIR/higgsCombiner5_np40.MultiDimFit.mH125.root --mu --muExpr "r5" -o scan_${DIR}_40p_r5
#python makeCombinePlots.py  -b -f /mnt/t3nfs01/data01/shome/vtavolar/combine74/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/test/$DIR/higgsCombiner6_np40.MultiDimFit.mH125.root --mu --muExpr "r6" -o scan_${DIR}_40p_r6
#python makeCombinePlots.py  -b -f /mnt/t3nfs01/data01/shome/vtavolar/combine74/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/test/$DIR/higgsCombiner7_np40.MultiDimFit.mH125.root --mu --muExpr "r7" -o scan_${DIR}_40p_r7
####python makeCombinePlots.py  -b -f /mnt/t3nfs01/data01/shome/vtavolar/combine74/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/test/$DIR/higgsCombiner4_np10.MultiDimFit.mH125.root --mu --muExpr "r8" -o scan_${DIR}_40p_r8
