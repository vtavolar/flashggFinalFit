...
python makeCombinePlots.py  -b -f /mnt/t3nfs01/data01/shome/vtavolar/combine74/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/test/$DIR/higgsCombiner3_np10.MultiDimFit.mH125.root --mu --muExpr "r3" -o scan_${NAME}_r3 --xaxis "-0.5,2.5"
python makeCombinePlots.py  -b -f /mnt/t3nfs01/data01/shome/vtavolar/combine74/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/test/$DIR/higgsCombiner4_np10.MultiDimFit.mH125.root --mu --muExpr "r4" -o scan_${NAME}_r4 --xaxis "-0.5,2.5"

python makeCombinePlots.py  -b -f /mnt/t3nfs01/data01/shome/vtavolar/combine74/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/test/$DIR/higgsCombiner0_np20.MultiDimFit.mH125.root --mu --muExpr "r0" -o scan_${NAME}_r0
python makeCombinePlots.py  -b -f /mnt/t3nfs01/data01/shome/vtavolar/combine74/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/test/$DIR/higgsCombiner1_np20.MultiDimFit.mH125.root --mu --muExpr "r1" -o scan_${NAME}_r1
python makeCombinePlots.py  -b -f /mnt/t3nfs01/data01/shome/vtavolar/combine74/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/test/$DIR/higgsCombiner2_np20.MultiDimFit.mH125.root --mu --muExpr "r2" -o scan_${NAME}_r2
python makeCombinePlots.py  -b -f /mnt/t3nfs01/data01/shome/vtavolar/combine74/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/test/$DIR/higgsCombiner3_np20.MultiDimFit.mH125.root --mu --muExpr "r3" -o scan_${NAME}_r3 --xaxis "-0.5,2.5"
python makeCombinePlots.py  -b -f /mnt/t3nfs01/data01/shome/vtavolar/combine74/CMSSW_7_4_7/src/HiggsAnalysis/CombinedLimit/test/$DIR/higgsCombiner4_np20.MultiDimFit.mH125.root --mu --muExpr "r4" -o scan_${NAME}_r4 --xaxis "-0.5,2.5"
...
cp scan*${NAME}* /afs/cern.ch/user/v/vtavolar/www/DiffHggPt/outdir_Differential_SignalModel_ICHEPconditions_1bis_newphp/Moriond17/outdir_${DIR}