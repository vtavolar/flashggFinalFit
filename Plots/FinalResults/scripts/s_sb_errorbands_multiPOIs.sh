...
do
echo "---> combine $dir/cms_hgg_datacard_FiducialRDiffXsScan_postFit.root -m $MHhat --snapshotName MultiDimFit -M GenerateOnly --saveWorkspace --toysFrequentist --bypassFrequentistFit -t 1 --setPhysicsModelParameters='$PhysModParams' -n combout_step0_$index -s -1"
combine $dir/inputfile.root  -m $MHhat --snapshotName MultiDimFit -M GenerateOnly --saveWorkspace --toysFrequentist --bypassFrequentistFit -t 1 --setPhysicsModelParameters='$PhysModParams' -n combout_step0_$index -s -1
