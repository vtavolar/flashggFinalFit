...
pair<double,double> getEffSigma(RooRealVar *mass, RooAbsPdf *pdf, double wmin=110., double wmax=130., double step=0.002, double epsilon=1.e-4){
  cout<<"Entering getEffSigma"<<endl;
...
int main(int argc, char *argv[]){
  ...
  if (isFlashgg_){
    std::cout<<"isFlashgg_ if"<<std::endl;
  ...
  for (map<string,RooDataSet*>::iterator dataIt=dataSets.begin(); dataIt!=dataSets.end(); dataIt++){
    std::cout<<"Iterating on datasets"<<std::endl;
    std::cout<<"iterator first "<<dataIt->first<<" , second name "<<dataIt->second->GetName()<<std::endl;
    std::cout<<"pdfs iterator first name "<<pdfs[dataIt->first]->GetName()<<std::endl;
    pair<double,double> thisSigRange = getEffSigma(mass,pdfs[dataIt->first],m_hyp_-10.,m_hyp_+10.);
    std::cout<<"got getEffSigma"<<std::endl;
  ...
  for (map<string,RooDataSet*>::iterator dataIt=dataSetsGranular.begin(); dataIt!=dataSetsGranular.end(); dataIt++){
    std::cout<<"Iterating on granular datasets"<<std::endl;
